...
control 'osw files' do
  ...
  files += [
    ...
    %w[/etc/php/8.1/fpm/php.ini                                         root                  root                  0644],
    %w[/etc/php/8.1/fpm/php-fpm.conf                                    root                  root                  0644],
    %w[/etc/php/8.1/fpm/pool.d/opensourcewebsite.org.conf               root                  root                  0644],
    %w[/etc/php/8.1/fpm/pool.d/www.conf                                 root                  root                  0644],
    %w[/etc/php/8.1/cli/php.ini                                         root                  root                  0644],
    ...
    %w[/etc/logrotate.d/php8.1-fpm                                      root                  root                  0644],
